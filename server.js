...
async function initDatabase() {
  ...
  // पुराने upcoming demo matches हटाएं
  // जिन matches में player join हो चुके हैं उन्हें नहीं हटाया जाएगा।
  await pool.query(`
  ...
  await pool.query(`
    ...
    VALUES
      ...
      ('PER KILL MATCHES', 'Per Kill Match #1', 10, 350, 48, 'upcoming', NOW() + INTERVAL '60 minutes'),
      ('CLASH SQUAD 1V1', 'Clash Squad 1V1 #1', 40, 55, 2, 'upcoming', NOW() + INTERVAL '90 minutes'),
      ('LONE WOLF 1V1', 'Lone Wolf 1V1 #1', 40, 55, 2, 'upcoming', NOW() + INTERVAL '120 minutes'),
      ('CLASH SQUAD 4V4', 'Clash Squad 4V4 #1', 20, 100, 8, 'upcoming', NOW() + INTERVAL '150 minutes'),
      ('LONE WOLF 2V2', 'Lone Wolf 2V2 #1', 25, 60, 4, 'upcoming', NOW() + INTERVAL '180 minutes');
  `);

  console.log('Exact 6 contests are ready.');
}
