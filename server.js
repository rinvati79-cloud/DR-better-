...
const AUTO_GAMES = {
  ...
  'PER KILL MATCHES': { prefix: 'Per Kill Match', entryFee: 11, prizePool: 350, slots: 48, startOffsetMinutes: 35 },
...
app.post('/api/auth/login', async (req, res) => {
  try {
    ...
    const r = await pool.query(
      'SELECT id,username,password_hash,game_uid,created_at FROM users WHERE username=$1',
      [username]
    );
